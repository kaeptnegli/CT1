...
[ARMs download page][gcc-download],
...
![VSCode profile settings](./resources/vs-code/vsc-profile.png)

After the Profiles window has opened, click the arrow next to the
*New Profile* button and select *Import Profile...*.

![VSCode profile import](./resources/vs-code/vsc-profile-import.png)

Navigate to the local repository and select
`../common/ct.code-profile`.

![VSCode profile path](./resources/vs-code/vsc-profile-path.png)
...
![VSCode profile create](./resources/vs-code/vsc-profile-create.png)
...
![Debug Window](./resources/vs-code/vsc-debug-window.png)
