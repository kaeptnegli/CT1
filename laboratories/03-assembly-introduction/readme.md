...
In **Keil** click on Memory 1 and enter the start address of the main
function code section in the field ‘Address’.
...
the initialisation code for the microcontroller.
